...
def main() -> None:
    ...
    title = {
        "en": "Stress-test ramp-up 2026–2055 — LOLE-P95 design standard",
        "de": "Stresstest-Hochlauf 2026–2055 — LOLE-P95-Auslegungsstandard",
    }[args.lang]
    subtitle = {
        "en": f"LOLE-P95 dark-doldrum reserve per path (BMWK reliability 2.77 h/a) · {set_label}",
        "de": f"LOLE-P95-Dunkelflauten-Reserve je Pfad (BMWK-Versorgungssicherheit 2,77 h/a) · {set_label}",
    }[args.lang]
